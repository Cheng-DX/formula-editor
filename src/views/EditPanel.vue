...
<template>
  ...
  <div flex hp-100>
    <div flex hp-100 wp-25 color-white flex-col items-center scroll-y>
      <div key="data" v-if="displayedData.length > 0" mt-10px wp-95>
        <div
    ...
    <div flex hp-100 wp-25 flex-col items-center scroll-y>
      ...
      <empty-panel text="No Formulas" key="formula-empty" v-else />
    </div>
  </div>
</template>
